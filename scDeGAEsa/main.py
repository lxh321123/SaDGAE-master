...
from scDeGAEsa import scDeGAEsa
...
args.save_final_model_path = f'./model/{args.name}_final_model.pkl'
...
model.load_state_dict(torch.load(args.save_pretrain_model_path))
